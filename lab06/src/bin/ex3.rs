...
async fn main(_spawner: Spawner) {
    ...
    // We will be using the mock calibration parameters from the lab
    // instructions:
    let nvm_par_t1: u16 = 27504;
    let nvm_par_t2: u16 = 26435;
    let nvm_par_t3: i8 = -50;

    // And calculate the parameters we need for the compensation formula based
    // on the raw values. Formula can be found in datasheet.
